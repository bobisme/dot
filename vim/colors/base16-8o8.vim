...
if &background == "dark"
  ...
  highlight DiffDelete guibg=#2C1011
  highlight DiffAdd guibg=#212717
  highlight DiffChange guibg=#2F4248 
  highlight DiffText guibg=#352218
else
